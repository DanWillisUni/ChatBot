...
\end{itemize}
	...
	\begin{figure}[!htb]
		...
		\begin{minipage}{.8\textwidth}
			...
			\captionof{figure}{Searching for the correct K value (Y axis is multiplied by 10)}
			\label{Img:KSearch}
		\end{minipage}%
...
\end{figure}
	...
	Interestingly though when using 100 trains instead of 1000 the neural network learnt far faster and quickly overtook the k nearest neighbour as seen in figure \ref{Img:NNKNNCompB} and figure \ref{Img:NNTrainD}.
	...
	\begin{figure}[!htb]
		\begin{center}
			\includegraphics[width=1\linewidth]{Resources/Screenshot 2022-01-28 at 15.23.51.png}
	...
	In order to make itself as clear as possible, the chatbot will use previous collected information in order to tailor the question, making it as clear as possible in what it is asking for as seen in figure \ref{Img:Userbility}.
